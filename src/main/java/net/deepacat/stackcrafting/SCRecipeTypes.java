...
import net.deepacat.stackcrafting.workbench.SWRecipeType;
...
public class SCRecipeTypes {
    ...
    public static final RegistryObject<RecipeType<SWRecipeType>> STACK_CRAFTING = RECIPE_TYPES.register("stack_crafting", () -> registerRecipeType("stack_crafting"));
